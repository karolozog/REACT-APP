...
function Navbar() {
  ...
  return (
    <div className='max-w-[1640px] mx-auto flex justify-between items-center p-4'>
        ...
        <h1 className='text-2xl sm:text-3xl large:text-4xl px-2'>
          Beast<span className='font-bold'>Eats</span>
        </h1> 
        <div className='hidden lg:flex items-cener bg-gray-200 rounded-full p-1 text-{14px]'>
        ...
        <div className='bg-black/80 fixed w-full h-screen z-10 top-0 left-0'></div>
         ...
         {/*szufladkowe*/}
         <div className={nav ? 'fixed top-0 left-0 w-[300px] h-screen bg-white z-10 duration-300' : 'fixed top-0 left-[-100%] w-[300ox] h-screen bg-white z-10 duration-300'}>
          ...
          <h2 className='text-2xl p-4'>Beast <span className='font-bold'>Eats</span> </h2>
           <nav>
            <ul className='flex flex-col p-4 text-gray-800'>
              ...
              <li className='text-xl py-4 flex'><BsFillSaveFill size={25} className='mr-4'/>Best Ofers</li>
